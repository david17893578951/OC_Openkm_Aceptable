				...
				<div class="col-lg-3">										
					...
					<form method="post">
						...
						<div class="btn-group pull-right">							
							...
							<button class="btn btn-primary" formaction="${pageContext.request.contextPath}/catalog/catalog">
								<span class="glyphicon glyphicon-save" aria-hidden="true"></span> Catalog
							</button>
						</div>
						<div class="row">
							<p>
